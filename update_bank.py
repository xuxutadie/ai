...
print(f'小学：{len(primary_single)}单选、{len(primary_multiple)}多选、{len(primary_boolean)}判断、{len(primary_short)}主观')
print(f'初中：{len(junior_single)}单选、{len(junior_multiple)}多选、{len(junior_boolean)}判断、{len(junior_short)}主观')
